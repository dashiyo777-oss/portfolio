...
const EVIDENCE = [
  ...
  {id:"E0550", pid:"P769", cat:"実績", sub:"健康政策", summary:"未病対策の推進", detail:"未病改善に向けた独自の取り組みを推進し、県民の健康増進を目指す施策を主導。", src:"神奈川県庁政策実績", url:"", rel:"公共性", impact:"中", date:"2025-07"},
  {id:"E0551", pid:"P772", cat:"実績", sub:"復興行政", summary:"震災復興への行政主導", detail:"震災からの早期復興を目指し、国や自治体との調整、予算獲得を指揮した。", src:"石川県庁政策実績", url:"", rel:"政策実現力", impact:"高", date:"2026-03"},
  {id:"E0552", pid:"P774", cat:"実績", sub:"経済政策", summary:"産業振興に向けた政策", detail:"県内産業の活性化に向けた施策と企業誘致の推進に関与した。", src:"山梨県庁政策実績", url:"", rel:"経済財政", impact:"低", date:"2025-07"},
  {id:"E0553", pid:"P778", cat:"実績", sub:"経済", summary:"産業振興施策の推進", detail:"地域の自動車産業基盤の維持と、新産業への投資促進を積極的に行っている。", src:"愛知県庁政策実績", url:"", rel:"経済財政", impact:"中", date:"2025-07"},
  {id:"E0554", pid:"P781", cat:"実績", sub:"観光振興", summary:"観光地としての持続可能な施策", detail:"京都の観光過剰（オーバーツーリズム）対策と地域振興の両立に向けた施策を主導。", src:"京都府庁実績", url:"", rel:"政策実現力", impact:"高", date:"2026-02"},
  {id:"E0555", pid:"P782", cat:"実績", sub:"経済政策", summary:"IR・万博の誘致と推進", detail:"大阪の経済活性化を目指し、IR（統合型リゾート）および万博誘致を強力に推進した。", src:"大阪府公式サイト", url:"", rel:"政策実現力", impact:"高", date:"2026-04"},
  {id:"E0556", pid:"P783", cat:"問題・疑惑", sub:"ガバナンス", summary:"県庁内ガバナンスを巡る混乱", detail:"職員からの告発等を巡る対応で県議会との対立や信頼失墜の指摘を受け、再選を経て対応中。", src:"報道各社", url:"", rel:"政治倫理", impact:"高", date:"2026-01"},
  {id:"E0557", pid:"P785", cat:"実績", sub:"経済", summary:"産業振興に向けた政策", detail:"地域の産業基盤強化を重視し、国政での人脈を活かした企業誘致を進めている。", src:"和歌山県庁実績", url:"", rel:"経済財政", impact:"中", date:"2025-07"},
  {id:"E0558", pid:"P788", cat:"実績", sub:"経済", summary:"インフラ整備の推進", detail:"地域交通や産業インフラの整備を主導。", src:"岡山県庁実績", url:"", rel:"政策実現力", impact:"低", date:"2025-06"},
  {id:"E0559", pid:"P789", cat:"実績", sub:"イノベーション", summary:"産学官連携による産業振興", detail:"イノベーション推進拠点の整備を主導し、広島の産業構造転換を試みている。", src:"広島県庁実績", url:"", rel:"経済財政", impact:"高", date:"2025-10"},
  {id:"E0560", pid:"P790", cat:"実績", sub:"経済", summary:"産業インフラの調整", detail:"地域産業の基盤維持に向けた政策を推進。", src:"山口県庁実績", url:"", rel:"経済財政", impact:"低", date:"2025-07"},
  {id:"E0561", pid:"P792", cat:"実績", sub:"国土交通", summary:"インフラ整備調整の実務", detail:"省庁の知見を活かし、地域交通インフラの整備を主導した。", src:"香川県庁実績", url:"", rel:"政策実現力", impact:"低", date:"2025-06"},
  {id:"E0562", pid:"P793", cat:"実績", sub:"行政運営", summary:"行政運営の安定化", detail:"長期間にわたる運営で、県政の安定化と政策の継続性を主導。", src:"愛媛県庁実績", url:"", rel:"政策実現力", impact:"中", date:"2025-07"},
  {id:"E0563", pid:"P794", cat:"実績", sub:"経済", summary:"地域資源の活用促進", detail:"地域資源を活かした産業振興施策を推進。", src:"高知県庁実績", url:"", rel:"経済財政", impact:"低", date:"2025-07"},
  {id:"E0564", pid:"P795", cat:"実績", sub:"経済", summary:"県経済の振興と調整", detail:"県内企業の支援や産業振興の調整を主導。", src:"福岡県庁実績", url:"", rel:"経済財政", impact:"中", date:"2025-07"},
  {id:"E0565", pid:"P796", cat:"実績", sub:"地域振興", summary:"佐賀ブランドの推進", detail:"佐賀の地域資源を活用したブランド化を主導した。", src:"佐賀県庁", url:"", rel:"政策実現力", impact:"中", date:"2025-01"},
  {id:"E0566", pid:"P798", cat:"実績", sub:"経済", summary:"大規模企業誘致の実績", detail:"半導体製造拠点の誘致を実現し、地域経済活性化を主導した。", src:"熊本県庁", url:"", rel:"経済財政", impact:"高", date:"2024-05"},
  {id:"E0567", pid:"P802", cat:"実績", sub:"外交・基地問題", summary:"基地問題の主張継続", detail:"基地負担軽減を求める主張を継続している。", src:"沖縄県庁", url:"", rel:"安全保障", impact:"高", date:"2026-03"},
  {id:"E0568", pid:"P806", cat:"実績", sub:"行政改革", summary:"行財政改革の訴え", detail:"自治体運営における徹底的な行財政改革をSNS等で発信した。", src:"活動記録", url:"", rel:"政策実現力", impact:"中", date:"2025-07"},
  {id:"E0569", pid:"P807", cat:"実績", sub:"行政改革", summary:"行政改革の推進", detail:"知事・市長として大規模な行財政改革を主導した。", src:"活動実績", url:"", rel:"政策実現力", impact:"高", date:"2024-05"},
  {id:"E0570", pid:"P808", cat:"実績", sub:"地方政治", summary:"知事としての行政経験", detail:"地方知事として行政を主導した。", src:"活動プロフィール", url:"", rel:"政策実現力", impact:"低", date:"2024-05"},
  {id:"E0571", pid:"P809", cat:"実績", sub:"地方政治", summary:"知事としての行政経験", detail:"地方知事として行政を主導した。", src:"活動プロフィール", url:"", rel:"政策実現力", impact:"低", date:"2024-05"},
  {id:"E0572", pid:"P810", cat:"実績", sub:"国政", summary:"政権運営の主導", detail:"長年、国政の中心で政権運営と党務を担った。", src:"国政実績", url:"", rel:"政策実現力", impact:"中", date:"2024-03"},
  {id:"E0573", pid:"P811", cat:"実績", sub:"外交", summary:"日ソ国交回復の実現", detail:"首相として外交交渉を主導し、長年の懸案であった日ソ国交回復を達成した。", src:"国立国会図書館 近代日本人の肖像", url:"https://www.ndl.go.jp/portrait/datas/473", rel:"長期国益", impact:"高", date:"1956-10"},
  {id:"E0574", pid:"P812", cat:"実績", sub:"厚生行政", summary:"薬害エイズ問題への対応", detail:"厚生大臣として薬害エイズ問題の責任を認め、被害者との和解を導く行政的決断を行った。", src:"首相官邸 歴代内閣", url:"https://www.kantei.go.jp/jp/rekidainaikaku/094.html", rel:"政治倫理", impact:"高", date:"1996-01"},
  {id:"E0575", pid:"P813", cat:"実績", sub:"外交", summary:"九州・沖縄サミットの完遂", detail:"小渕内閣から引き継いだ九州・沖縄サミットを首脳として円滑に完遂させた。", src:"自由民主党 党のあゆみ", url:"https://www.jimin.jp/aboutus/history/19.html", rel:"政策実現力", impact:"中", date:"2000-07"}
];
