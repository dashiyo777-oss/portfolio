...
const POLITICIANS = [
  ...
  },
  {
    ...
    chamber:"参議院", district:"比例", status:"現職", gender:"男", age:null,
    total:42, rank:"D",
    axes:[2,2,3,3,2,2,2,1],
    stances:{tax_cut:"○",active_fiscal:"◎",discipline:"×",defense:"×",econ_sec:"△",immigration:"○",renewable:"○",nuclear:"×",expo:"△",ir:"×",mynumber:"△",birthrate:"△",education:"○",regional:"△",china:"○",foreign:"○",food:"△",semi:"△"},
    plus:"国連東ティモール上級民政官・シエラレオネ武装解除部長・アフガニスタン日本政府特別顧問を歴任した唯一無二の「停戦実務家」議員。安保論議に国際人道法・地位協定など実務的視点を持ち込む。", minus:"ウクライナ侵攻巡り「ロシアだけが絶対悪魔なんですか？」発言が批判殺到。即時停戦署名運動は2週間で3000人未満と低調。非武装・緩衝国家論は現実的安全保障論との整合性に疑問。",
    comment:"国連・NGOを通じた世界各地の武装解除・停戦実務の第一人者として独自の安保論を展開するが、ウクライナ問題でのロシア相対化発言は国際社会の常識と乖離し信頼性を損なう。参院国対委員長を務めるが1期目として立法実績は限定的。",
    links:{hp:"",tw:"",yt:"",wiki:""},
    flag_crime:false, flag_caution:true, updated:"2026.05", survey:"評価済"
  },
  {
